...
mv localhost.conf /etc/nginx/default.d/roboshop.conf &>>$LOG_FILE && sed -e '/catalogue/s/localhost/catalogue.roboshop.internal/' /etc/nginx/default.d/roboshop.conf &>>$LOG_FILE
Status_Check $?
